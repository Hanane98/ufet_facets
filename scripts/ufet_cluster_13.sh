...
srun python ./src/domain_model/main.py -multitask -tune_all -do_train -optim_th -model_id bert_base_cased_complete_clusters_50jethresh -d_goal ce_cluster -dfn_postfix complete_clusters_50jethresh -dfc_param ufet_domain_types_from_clusters\cross_entopy_bert_large\cnetp_vocab\bert_base_cased_dfc_complete_clusters_50jethresh.pt