...
srun python ./src/domain_model/main.py -multitask -tune_all -do_train -optim_th -model_id bert_base_cased_complete_cluster_cnetpchatgpt100kvocab_filterthresh50 -d_goal ce_cluster_gpt -dfn_postfix complete_cluster_cnetpchatgpt100kvocab_filterthresh50 -dfc_param ufet_domain_types_from_clusters\cross_entopy_bert_large\cnetp_chatgpt100k_vocab\bert_base_cased_dfc_complete_cluster_cnetpchatgpt100kvocab_filterthresh50.pt