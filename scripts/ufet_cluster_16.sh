...
srun python ./src/domain_model/main.py -multitask -tune_all -do_train -optim_th -model_id bert_base_cased_mcrae_cslb_debv3l_0.75thresh_filter_cnetp_chatgpt100k_bert_large_con_50simprop_clustered_file -d_goal ce_cluster -dfn_postfix mcrae_cslb_debv3l_0.75thresh_filter_cnetp_chatgpt100k_bert_large_con_50simprop_clustered_file -dfc_param ufet_domain_types_from_clusters\cross_entopy_bert_large\cnetp_vocab\bert_base_cased_dfc_mcrae_cslb_debv3l_0.75thresh_filter_cnetp_chatgpt100k_bert_large_con_50simprop_clustered_file.pt