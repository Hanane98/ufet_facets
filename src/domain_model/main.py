...
if __name__ == '__main__':
    ...
    parser.add_argument("-model_id", help="Identifier for model", default="bert_base_cased_cl_cluster_gpt_compelete_0.5th")
    ...
    parser.add_argument("-d_goal", help="type vocab", default="cl_cluster_gpt")
    parser.add_argument("-dfn_postfix", help="postfix of domain type file name", default="complete_cluster_filterthres0.5")
    ...
    parser.add_argument('-dfc_param', type=str, default='ufet_domain_types_from_clusters/contrastive_bert_large/cnetp_chatgpt100k_vocab/bert_base_cased_dfc_complete_cluster_filterthres0.5.pt') # 'numberbatch/crowd/bert_base_cased_dfc.pt'
