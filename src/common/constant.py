...
VOCAB_DIR_DICT = {"nb": os.path.join(DATA_ROOT, 'ontology/domain/numberbatch'),
                  ...
                  "emb": os.path.join(DATA_ROOT, 'domain_embeddings/'),
                  "rel_cluster_0.75_0.9": os.path.join(DATA_ROOT, 'ufet_domain_types_from_clusters/relational_property_filter_thresh_0.75_0.90'),
                  "ce_1406": os.path.join(DATA_ROOT,'clusters1406/ce_cnetp_chatgpt_ce_model_complete_clusters'),
                  "ce_0620": os.path.join(DATA_ROOT, "ce_cnetp_vocab_cnetp_bienc_0620"),
                  "combine_0621_1": os.path.join(DATA_ROOT, "combined_clusters0621/chatgpt100k_vocab_chatgpt100k_bienc"),
                  "combine_0621_2": os.path.join(DATA_ROOT, "combined_clusters0621/cnetp_chatgpt100k_vocab"),
                  "combine_0621_3": os.path.join(DATA_ROOT, "combined_clusters0621/cnetp_chatgpt100k_vocab_chatgpt100k_bienc"),
                  "bienc_1406": os.path.join(DATA_ROOT,'clusters1406/chatgpt100k_vocab_chatgpt100k_bienc'),
                  "cnept_1406": os.path.join(DATA_ROOT,'clusters1406/cnetp_chatgpt100k_vocab'),
                  "bienc_cnept_1406": os.path.join(DATA_ROOT,'clusters1406/cnetp_chatgpt100k_vocab_chatgpt100k_bienc'),
                  "cluster_ap0623": os.path.join(DATA_ROOT, 'clusters_ap0623'),
                  "facets_cluster": os.path.join(DATA_ROOT, "facets_clusters20240125")}
